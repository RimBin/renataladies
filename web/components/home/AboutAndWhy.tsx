          ...
          <div className="rl-section-header">
            ...
            <div>
              <p className="rl-section-copy">
                15 metų patirtis, šimtai padėtų moterų ir įrodyta sistema, kuri
                veikia.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-8">
              <div>
                <p className="text-lg text-neutral-600 mb-8">
                  Tai ne trumpalaikė dieta ar ekstremali programa – tai
                  ilgalaikis gyvenimo būdo keitimas, kuris tampa natūraliu ir
                  maloniu. Kiekviena moteris unikali, todėl mano sistema
                  pritaikoma individualiai – atsižvelgiant į tikslus, gyvenimo
                  ritmą, mitybos įpročius ir fizinį aktyvumą.
                </p>
              </div>
              <div className="mb-8">
